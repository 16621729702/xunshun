...
@Service
public class LmAuctionBidServiceImpl implements LmAuctionBidService{
	@Resource
	private LmAucitonBidDao lmAucitonBidDao;
	


	@Override
	public List<LmAuctionBid> findlist() {
		// TODO Auto-generated method stub
		return lmAucitonBidDao.findlist();
	}
