!function (window) {
    ...
    util.iconBrowser = function (e) {
        ...
        var o = function (t, a) {
            ...
            d && (e.toolbars = [["fullscreen", "source", "preview", "|", "bold", "italic", "underline", "strikethrough", "forecolor", "backcolor", "|", "justifyleft", "justifycenter", "justifyright", "|", "insertorderedlist", "insertunorderedlist", "blockquote", "emotion", "link", "removeformat", "|", "rowspacingtop", "rowspacingbottom", "lineheight", "indent", "paragraph", "fontfamily", "fontsize", "|", "inserttable", "deletetable", "insertparagraphbeforetable", "insertrow", "deleterow", "insertcol", "deletecol", "mergecells", "mergeright", "mergedown", "splittocells", "splittorows", "splittocols", "|", "anchor", "print", "drafts", "addgoods"]]);
            var r = {
                type: "image",
                direct: !1,
                multiple: !0,
            ...
            if (t.registerUI("myinsertimage", function (o, e) {
                ...
                e.registerCommand(i, {
                    execCommand: function () {
                        ...
                        }, {fileSizeLimit: 1024 * l.audio_limit, type: "voice"})
                    }
                });
                var o = new t.ui.Button({
                    name: "voice",
    ...
    }, util.message = function (t, e, i) {
        e || i || (i = "info"), -1 == $.inArray(i, ["success", "error", "info", "warning"]) && (i = ""), "" == i && (i = "" == e ? "error" : "success");
        if (e && 0 < e.length) {
            if ("success" == i) {
                var o = new Object;
                return o.type = i, o.msg = t, util.cookie.set("message", JSON.stringify(o), 600), "back" == e ? window.history.back(-1) : window.location.href = ("refresh" == e && (e = location.href), e)
            }
            "back" == e ? e = "javascript:history.back(-1)" : "refresh" == e && (e = location.href);
            var n = "\t\t\t<a href=" + e + ' class="btn btn-primary">确认</a>'
        } else n = '\t\t\t<button type="button" class="btn btn-primary" data-dismiss="modal">确认</button>';
        var a = '\t\t\t<div class="text-center">\t\t\t\t<i class="text-' + i + " wi wi-" + {
                success: "right-sign",
                error: "error-sign",
                danger: "error-sign",
                info: "info",
                warning: "warning-sign"
            }[i] + '"></i>\t\t\t\t<p class="title">系统提示</p> \t\t\t\t<p class="content">' + t + '</p>\t\t\t</div>\t\t\t<div class="clearfix"></div>',
            r = "modal-message-" + Math.floor(1e4 * Math.random()), l = $("#" + r);
        return 0 == l.length && ($(document.body).append('<div id="' + r + '" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true"></div>'), l = $("#" + r)), html = '<div class="modal-dialog modal-tip">\t<div class="modal-content">\t\t<div class="modal-header clearfix">\t\t\t<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>\t\t</div>\t\t<div class="modal-body">' + a + '</div>\t\t<div class="modal-footer">' + n + "</div>\t</div></div>", l.html(html), e && 0 < e.length && "success" != i && l.on("hidden.bs.modal", function () {
        ...
        if (!i || getQuery(i) == getQuery(window.location.href)) {
            var r = !1, l = "";
            if (o || (o = "info"), -1 == $.inArray(o, ["success", "error", "info", "warning", "danger"]) && (o = ""), "" == o && (o = "success"), -1 != $.inArray(o, ["success"]) && (r = !0, n = n || 3), r) l = '\t<button type="button" class="btn btn-primary" data-dismiss="modal">确认</button>'; else if (t = t || "系统提示", l = '\t\t<a href="' + (i = i || "./?refresh") + '" class="btn btn-primary">确认</a>', "" != a && 0 < a.length) for (var d = 0; d < a.length; d++) l = l + '<a href="' + a[d].url + '" class="btn btn-primary">' + decodeURIComponent(a[d].title) + "</a>";
        ...
        if ("x" != window.sysinfo.family && !window.localStorage.getItem("checkResult") && !util.cookie.get("__checkRecord")) {
            var n = [{
                description: "域名绑定",
                url: "c=profile&a=bind-domain",
                pattern: /<[a-z]{2}><.*?>域名绑定设置<\/[a-z]{2}><\/[a-z]{2}>/,
                uid: !0,
                uniacid: !0,
                role: ["owner", "manager", "founder"]
            }, {
                description: "商城",
                url: "c=site&a=entry&direct=1&do=goodsbuyer&m=store",
                pattern: /<.*?>订单管理<.*?><\/[a-z]{1}><\/[a-z]{4}>/,
                uid: !0,
                uniacid: !1,
                role: ["founder"]
            }, {
                description: "打包一个小程序",
                url: "c=wxapp&a=post&do=post&design_method=3&uniacid=0&create_type=1",
                pattern: /<.*?>小程序名称<\/[a-z]{5}>/,
                uid: !0,
                uniacid: !1,
                role: ["owner", "manager", "founder"]
                ...
                description: "打包多个小程序",
                url: "c=wxapp&a=post&do=post&design_method=3&uniacid=0&create_type=2",
                pattern: /<.*?>小程序名称<\/[a-z]{5}>/,
                uid: !0,
                uniacid: !1,
                role: ["owner", "manager", "founder"]
                ...
                description: "副创始人",
                url: "c=founder&a=display",
                pattern: /<.*?>\+添加副创始人<\/[a-z]{1}>/,
                uid: !1,
                uniacid: !0,
                role: ["vice_founder", "founder"]
            }, {
                description: "副创始人组",
                url: "c=founder&a=group&",
                pattern: /<.*?>\+添加副创始人组<\/[a-z]{1}>/,
                uid: !0,
                uniacid: !1,
                role: ["vice_founder", "founder"]
            }, {
                description: "API统计功能",
                url: "c=statistics&a=app",
                pattern: /<.*?>API余量<\/[a-z]{3}>/,
                uid: !0,
                uniacid: !0,
                role: ["owner", "manager", "founder"]
